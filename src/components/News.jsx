...
const News = () => {
    ...
    return (
        <div>
            <div className='bg-[url(./src/assets/bannerImage.jpg)] bg-no-repeat bg-cover bg-black/50 w-full h-[400px]  bg-center w-full'>
            ...
            <div className='w-1/4 border-2 border-red-800'>
                <NewsRight></NewsRight>
            </div>
            </div>
        </div>
